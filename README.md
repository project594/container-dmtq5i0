...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dmtq5i0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dmtq5i0.containers.anotherwebservice.com/
...
```
git clone git@github.com:project594/container-dmtq5i0.git
cd container-dmtq5i0
```
...
```
docker attach container-dmtq5i0
```
